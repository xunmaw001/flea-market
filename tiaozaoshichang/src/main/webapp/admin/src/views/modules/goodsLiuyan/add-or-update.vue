        ...
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="24" v-if="sessionTable !='goods' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.goodsPhoto" label="照片" prop="goodsPhoto">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.goodsPhoto" label="照片" prop="goodsPhoto">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评论内容" prop="goodsLiuyanText">
                        <el-input type="textarea"  :readonly="ro.goodsLiuyanText" v-model="ruleForm.goodsLiuyanText" placeholder="评论内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.goodsLiuyanText" label="评论内容" prop="goodsLiuyanText">
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='goodsLiuyanText'){
                          this.ruleForm.goodsLiuyanText = obj[o];
                          this.ro.goodsLiuyanText = true;
                          continue;
                      }
                      if(o=='insertTime'){
