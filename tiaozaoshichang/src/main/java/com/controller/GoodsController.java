    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(goods !=null){
            ...
            BeanUtils.copyProperties( goods , view );//把实体数据重构到view中
                ...
                //级联表
                YonghuEntity yonghu = yonghuService.selectById(goods.getYonghuId());
                if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody GoodsEntity goods, HttpServletRequest request){
        ...
        if(StringUtil.isEmpty(role))
            ...
            goods.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        Wrapper<GoodsEntity> queryWrapper = new EntityWrapper<GoodsEntity>()
            ...
            .eq("yonghu_id", goods.getYonghuId())
...
//                            goodsEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户id 要改的
